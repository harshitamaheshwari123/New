    ...
    <section id="initiatives" className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-card">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-5xl">Public Policy & Governance Society</h2>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12">
            <h3 className="text-2xl font-semibold text-center mb-6 text-primary">Active In:</h3>
            <div className="flex flex-wrap justify-center gap-3">
              {activeIn.map((place, index) => (
                <Badge key={index} variant="secondary" className="text-base py-2 px-4 rounded-full transition-transform hover:scale-110">
                  {place}
                </Badge>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {initiatives.map((initiative, index) => (
                <Card key={index} className="flex flex-col text-center items-center p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
